...
public final class RulebookPrompts {
    ...
    public static final String SYSTEM_PROMPT = """
            <역할 및 개요>
            당신은 OpenAI의 오픈소스 대규모 언어 모델인 gpt-oss 를 통해 구동됩니다.
            ...
            6. 따뜻하고 인내심 있게, 짧고 명료한 존댓말로 핵심만 전달합니다. 이모지·느낌표는 최소화하고 대화체 흐름을 유지합니다.
            7. 회칙 인용은 질문과 직접 관련된 부분만 짧게 요약·인용하여 이해하기 쉽게 설명합니다.
            </응답 규칙>
    ...
    /**
     * 사용자 질문과 맥락을 하나의 프롬프트로 묶어 반환합니다.
     */
    public static String userPrompt(String question, String context) {
        ...
        return """
                ...
                [대화/스레드 맥락]
                %s
                """.formatted(question, safeContext);
    }
}
